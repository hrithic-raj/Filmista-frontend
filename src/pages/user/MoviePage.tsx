function MoviePage() {
  return (
    <div className="w-[1531px] h-[3324px] relative bg-[#212121]  overflow-hidden">
  <div className="w-[807px] h-[359px] left-[378px] top-[251px] absolute">
  ...
  <div className="w-[181px] h-[359px] left-[1225px] top-[251px] absolute">
  ...
  <div className="left-[383px] top-[150px] absolute text-white text-5xl font-bold font-['Gelasio']">Joker</div>
  <div className="left-[388px] top-[208px] absolute text-[#46cec2] text-xl font-bold font-['Gelasio']">2024</div>
  <div className="w-[796px] left-[378px] top-[633px] absolute text-white text-xl font-bold font-['Inter']">Struggling with his dual identity, failed comedian Arthur Fleck meets the love of his life, Harley Quinn, while incarcerated at Arkham State Hospital.</div>
  <div className="w-[198px] h-6 left-[378px] top-[699px] absolute">
  ...
  <div className="w-[205px] h-[29px] left-[380px] top-[750px] absolute" />
  <div className="w-[812px] h-[125px] left-[378px] top-[809px] absolute">
  ...
  <div className="w-[177px] h-[39px] left-[997px] top-[749px] absolute">
    <div className="w-[177px] h-[39px] left-0 top-0 absolute bg-[#46cec2]/80 rounded-[15px]" />
    <div className="w-[118px] left-[48px] top-[8px] absolute text-[#e8e8e8] text-[15px] font-normal font-['Geologica']">Add to watchlist</div>
    <div className="w-6 h-6 left-[16px] top-[7px] absolute  overflow-hidden" />
  </div>
  <div className="w-[807px] h-[488px] left-[378px] top-[1191px] absolute">
    <div className="w-[111px] h-[39px] left-[682px] top-[24px] absolute">
      ...
      <div className="left-[46px] top-[9px] absolute text-[#e8e8e8] text-[15px] font-normal font-['Geologica']">Review</div>
    ...
    <div className="w-[807px] h-[403px] left-0 top-[85px] absolute">
      <div className="w-[731px] h-[353px] left-[30px] top-[18px] absolute">
        <div className="w-[233px] h-[25px] left-[22px] top-[73px] absolute">
          <div className="left-0 top-0 absolute text-[#e8e8e8] text-xl font-bold font-['Geologica']">Highly disappointing</div>
        </div>
      ...
      <div className="w-[807px] h-[62px] left-0 top-[341px] absolute">
        <div className="w-[807px] h-[62px] left-0 top-0 absolute bg-[#2c2c2c] rounded-bl-[15px] rounded-br-[15px] border-l border-r border-b border-[#e8e8e8]" />
  ...
  <div className="w-[212px] h-[45px] left-[382px] top-[969px] absolute">
    <div className="left-[36px] top-0 absolute text-white text-4xl font-normal font-['Geologica']">Top Cast</div>
  </div>
  <div className="w-[807px] h-[488px] left-[378px] top-[1739px] absolute">
    ...
    <div className="w-[807px] h-[403px] left-0 top-[85px] absolute">
      ...
      <div className="w-[807px] h-[62px] left-0 top-[336px] absolute">
        ...
        <div className="w-[59px] h-[39px] left-[423px] top-[10px] absolute">
          ...
          <div className="left-[10px] top-[10px] absolute text-[#e8e8e8] text-[15px] font-normal font-['Geologica']">POST</div>
        </div>
      </div>
    </div>
  </div>
  <img className="w-[87px] h-[87px] left-[389px] top-[1044px] absolute rounded-full border border-[#e8e8e8]" src="https://via.placeholder.com/87x87" />
  <img className="w-[87px] h-[87px] left-[511px] top-[1044px] absolute rounded-full border border-[#e8e8e8]" src="https://via.placeholder.com/87x87" />
  <img className="w-[87px] h-[87px] left-[633px] top-[1044px] absolute rounded-full border border-[#e8e8e8]" src="https://via.placeholder.com/87x87" />
  <img className="w-[87px] h-[87px] left-[755px] top-[1044px] absolute rounded-full border border-[#e8e8e8]" src="https://via.placeholder.com/87x87" />
  <img className="w-[87px] h-[87px] left-[877px] top-[1044px] absolute rounded-full border border-[#e8e8e8]" src="https://via.placeholder.com/87x87" />
  <div className="w-[87px] h-[87px] left-[999px] top-[1044px] absolute bg-[#2c2c2c] rounded-full border border-[#e8e8e8]" />
  <div className="left-[1013px] top-[1073px] absolute text-[#e8e8e8] text-2xl font-normal font-['Geologica']">More</div>
  <div className="w-[1074px] h-[51px] left-[380px] top-[59px] absolute">
    <div className="w-[247px] h-[54px] left-[827.40px] top-0 absolute">
      <div className="w-[245.40px] h-[50px] left-[1.60px] top-0 absolute bg-[#2c2c2c] rounded-[215.70px]" />
      <img className="w-10 h-10 left-0 top-[4px] absolute rounded-[172.56px] border border-[#e8e8e8]" src="https://via.placeholder.com/40x40" />
      <div className="w-[17.58px] h-3.5 left-[199px] top-[17px] absolute">
      </div>
      <div className="w-[135px] h-7 left-[49px] top-[5px] absolute text-[#e8e8e8] text-[18.84px] font-normal font-['Geologica']">Hrithic raj</div>
      <div className="w-[135px] h-7 left-[57px] top-[26px] absolute text-[#e9e9e9]/80 text-[11px] font-normal font-['Geologica']">@hrj_clown</div>
    </div>
    <div className="w-[116px] h-[50px] left-0 top-0 absolute">
      <div className="w-[116px] h-[50px] left-0 top-0 absolute bg-[#2c2c2c] rounded-[408.80px]" />
      <div className="w-[24.25px] left-[27.42px] top-[12.19px] absolute opacity-90 text-white text-[18.84px] font-normal font-['Geologica']">All</div>
      <div className="w-[27.81px] h-[22.61px] left-[60.20px] top-[13.13px] absolute  overflow-hidden" />
    </div>
    <div className="w-[517.08px] h-[50px] left-[136px] top-0 absolute">
      <div className="w-[517.08px] h-[50px] left-0 top-0 absolute bg-[#2c2c2c] rounded-[215.70px]" />
      <div className="w-[71.40px] h-[23.55px] left-[19.62px] top-[13.13px] absolute opacity-90 text-[#828282] text-[18.84px] font-normal font-['Geologica']">Search</div>
    </div>
    <div className="w-[132.96px] h-[51px] left-[674.04px] top-0 absolute">
      <div className="w-[56.18px] h-[50px] left-[76.78px] top-[1px] absolute">
        <div className="w-[56.18px] h-[50px] left-0 top-0 absolute bg-[#2c2c2c] rounded-[215.70px]" />
      </div>
      <div className="w-[56.18px] h-[50px] left-[-0px] top-0 absolute">
        <div className="w-[56.18px] h-[50px] left-0 top-0 absolute bg-[#2c2c2c] rounded-[215.70px]" />
        <div className="w-[28.09px] h-[25px] left-[13.48px] top-[14px] absolute  overflow-hidden" />
      </div>
    </div>
  </div>
  <div className="w-[257px] h-[699px] left-[80px] top-[59px] absolute">
    <div className="w-[257px] h-[699px] left-0 top-0 absolute bg-[#2c2c2c] rounded-[36px]" />
    <div className="w-[218.30px] h-[608.95px] left-[30px] top-[50.99px] absolute">
      <div className="w-[192.97px] h-[102.94px] left-0 top-[506.01px] absolute">
        <div className="w-[54.74px] h-[23.94px] left-[1.37px] top-[44.77px] absolute">
          <div className="w-[54.74px] h-[23.94px] left-0 top-0 absolute bg-[#fefefe]/0 rounded-[36px] border border-[#e8e8e8]" />
          <div className="w-[31.90px] h-[14.15px] left-[11.03px] top-[3.97px] absolute text-[#e8e8e8] text-[11px] font-normal font-['Fredoka']">Action</div>
        </div>
        <div className="w-[76.64px] h-[23.94px] left-[59px] top-[45px] absolute">
          <div className="w-[76.64px] h-[23.94px] left-0 top-0 absolute bg-[#fefefe]/0 rounded-[36px] border border-[#e8e8e8]" />
          <div className="w-[51.84px] h-[14.15px] left-[12.03px] top-[3.97px] absolute text-[#e8e8e8] text-[11px] font-normal font-['Fredoka']">Adventure</div>
        </div>
        <div className="w-[51.09px] h-[23.94px] left-[139px] top-[44px] absolute">
          <div className="w-[51.09px] h-[23.94px] left-0 top-0 absolute bg-[#fefefe]/0 rounded-[36px] border border-[#e8e8e8]" />
          <div className="w-[31.90px] h-[14.15px] left-[10.20px] top-[3.97px] absolute text-[#e8e8e8] text-[11px] font-normal font-['Fredoka']">Anime</div>
        </div>
        <div className="w-[65.69px] h-[23.94px] left-[68px] top-[79px] absolute">
          <div className="w-[65.69px] h-[23.94px] left-0 top-0 absolute bg-[#fefefe]/0 rounded-[36px] border border-[#e8e8e8]" />
          <div className="w-[40.87px] h-[14.15px] left-[12.94px] top-[3.97px] absolute text-[#e8e8e8] text-[11px] font-normal font-['Fredoka']">Comedy</div>
        </div>
        <div className="w-[64.78px] h-[23.94px] left-0 top-[79px] absolute">
          <div className="w-[64.78px] h-[23.94px] left-0 top-0 absolute bg-[#fefefe]/0 rounded-[36px] border border-[#e8e8e8]" />
          <div className="w-[39.87px] h-[14.15px] left-[12.94px] top-[3.97px] absolute text-[#e8e8e8] text-[11px] font-normal font-['Fredoka']">Fantacy</div>
        </div>
        <div className="w-[192.51px] h-[24.17px] left-[0.46px] top-0 absolute text-[#e8e8e8] text-base font-normal font-['Fredoka']">Favorite genres</div>
      </div>
      <div className="w-[102.30px] h-[25.16px] left-[12px] top-[371.01px] absolute">
        <div className="w-6 h-6 left-0 top-0 absolute  overflow-hidden" />
        <div className="w-[64.30px] h-[23.63px] left-[38px] top-[1.53px] absolute text-[#e8e8e8] text-base font-normal font-['Fredoka']">Settings</div>
      </div>
      <div className="w-[92.15px] h-[26.44px] left-[12px] top-[309.01px] absolute">
        <div className="w-6 h-6 left-0 top-0 absolute  overflow-hidden" />
        <div className="w-[54.15px] h-[23.63px] left-[38px] top-[2.80px] absolute text-[#e8e8e8] text-base font-normal font-['Fredoka']">Profile</div>
      </div>
      <div className="w-[114.58px] h-[25.11px] left-[12px] top-[215.01px] absolute">
        <div className="w-6 h-6 left-0 top-0 absolute  overflow-hidden" />
        <div className="w-[75.58px] h-[23.63px] left-[39px] top-[1.48px] absolute text-[#e8e8e8] text-base font-normal font-['Fredoka']">Watchlist</div>
      </div>
      <div className="w-[101.17px] h-[25.94px] left-[12px] top-[153.01px] absolute">
        <div className="w-6 h-6 left-0 top-0 absolute  overflow-hidden">
          <div className="w-5 h-5 left-[2px] top-[2px] absolute">
          </div>
        </div>
        <div className="w-[63.17px] h-[23.63px] left-[38px] top-[2.31px] absolute text-[#5cfef0] text-base font-normal font-['Fredoka']">Explore</div>
      </div>
      <div className="w-[86.54px] h-[27.11px] left-[10.84px] top-[90.52px] absolute">
        <div className="w-[26.61px] h-[26.79px] left-0 top-0 absolute  overflow-hidden" />
        <div className="w-[47.38px] h-[23.63px] left-[39.16px] top-[3.48px] absolute text-[#e8e8e8] text-base font-normal font-['Fredoka']">Home</div>
      </div>
      <div className="w-[208.80px] h-[39.90px] left-[9.50px] top-0 absolute">
        <div className="w-[169.32px] h-[39.90px] left-[39.48px] top-0 absolute"><span className="text-white text-2xl font-normal font-['Baloo Bhai'] tracking-[2.64px]">Film</span><span className="text-white text-2xl font-normal font-['Baloo Bhai 2'] tracking-[2.64px]">ista</span></div>
        <div className="w-[27.09px] h-[29.77px] left-0 top-[4.62px] absolute">
        </div>
      </div>
    </div>
  </div>
