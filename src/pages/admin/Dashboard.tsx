...
//           { title: 'Active Celebrities', value: '345', change: '+3%' },
//           { title: 'Total Movies', value: '1,234', change: '-1%' },
//           { title: 'Revenue', value: '$123,456', change: '+8%' },
//         ].map((card, idx) => (
//           <div
//             key={idx}
...
//       {/* Data Table */}
//       <div className="p-6 bg-white shadow rounded-lg">
//         <h2 className="text-xl font-semibold text-gray-800 mb-4">Latest Movies</h2>
//         <div className="overflow-x-auto">
//           <table className="min-w-full table-auto border-collapse">
//             <thead>
//               <tr className="bg-gray-200">
//                 <th className="px-4 py-2 text-left text-sm text-gray-600 font-medium">
//                   Movie Title
//                 </th>
//                 <th className="px-4 py-2 text-left text-sm text-gray-600 font-medium">
//                   Genre
...
//             <tbody>
//               {[
//                 { title: 'The Great Escape', genre: 'Action', rating: '8.5', date: '2025-01-01' },
//                 { title: 'Romance in Paris', genre: 'Romance', rating: '7.2', date: '2024-12-24' },
//                 { title: 'Horror Night', genre: 'Horror', rating: '6.8', date: '2024-10-31' },
//                 { title: 'Comedy Blast', genre: 'Comedy', rating: '7.9', date: '2024-09-15' },
//               ].map((movie, idx) => (
//                 <tr key={idx} className="border-t">
//                   <td className="px-4 py-2 text-sm text-gray-800">{movie.title}</td>
//                   <td className="px-4 py-2 text-sm text-gray-800">{movie.genre}</td>
//                   <td className="px-4 py-2 text-sm text-gray-800">{movie.rating}</td>
//                   <td className="px-4 py-2 text-sm text-gray-800">{movie.date}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
...
//         label: 'Popularity',
//         data: [46, 17, 19, 29],
//         backgroundColor: ['#5DADE2', '#F4D03F', '#A569BD', '#EC7063'],
//       },
//     ],
//   };
...
//         data: [120, 190, 300, 500, 200, 300, 400, 450, 320, 410, 200, 350],
//         borderColor: '#5DADE2',
...
//   return (
//     <main className="bg-gray-900 text-white p-6 flex flex-col gap-6">
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
//         <div className="bg-gray-800 p-4 rounded-lg">$5k Total Sales</div>
//         <div className="bg-gray-800 p-4 rounded-lg">500 Total Orders</div>
//         <div className="bg-gray-800 p-4 rounded-lg">9 Products Sold</div>
//         <div className="bg-gray-800 p-4 rounded-lg">12 New Customers</div>
//       </div>
