...
//           />
//           <span className="hidden lg:flex h-7 text-[#e9e9e9] text-lg font-normal font-['Geologica']">Hrithic Raj</span>
//           {isProfile?(
...
//         </div>
//           {isProfile &&(
//             <div className='absolute top-16 right-0 w-[100px] lg:w-3/4 h-[130px] rounded-[16px] bg-[#2c2c2c] border border-gray-300'>
